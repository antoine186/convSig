...
The first dimension is 2 because there are only two distinct original bases possible
pre-mutation; That is because of the reverse complementarity nature of the genome.
The second dimension is 3 because there are only three possible mutated bases per
each of the 2 original bases. <br />
The below function call runs the ReLU transformation. It requires
